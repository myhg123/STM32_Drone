...
const unsigned char UBX_PRT_INIT[] = {

	0xB5, 0x62, 0x06, 0x00,0x14,0x00,0x01,0x00,0x00,0x00,0xD0,
	0x08,0x00,0x00,0x80,0x25,0x00,0x00,0x23,0x00,0x03,0x00,0x00,
	0x00,0x00,0x00,0xBE,0x95
};
//B5 62 06 00 14 00 01 00 00 00 D0 08 00 00 80 25 00  µbÐ%
//00 23 00 03 00 00 00 00 00 BE 95
...
void M8N_NMEA_initialization(void){
	M8N_TransmitData(&UBX_PRT_INIT[0], sizeof(UBX_PRT_INIT));
}
